...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool loading, Login? data, bool error});
...
class _$_Initial implements _Initial {
  const _$_Initial({required this.loading, this.data, required this.error});
  ...
  @override
  String toString() {
    return 'LoginState(loading: $loading, data: $data, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loading, data, error);
...
abstract class _Initial implements LoginState {
  const factory _Initial(
      ...
      final Login? data,
      required final bool error}) = _$_Initial;
